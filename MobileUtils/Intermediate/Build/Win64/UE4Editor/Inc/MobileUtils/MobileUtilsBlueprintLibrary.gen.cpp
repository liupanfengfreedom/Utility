...
// End Cross Module References
	DEFINE_FUNCTION(UMobileUtilsBlueprintLibrary::execConvertToAbsolutePath)
	{
	...
	DEFINE_FUNCTION(UMobileUtilsBlueprintLibrary::execStartActivity)
	{
	...
	DEFINE_FUNCTION(UMobileUtilsBlueprintLibrary::execSetOrientation)
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_orientation);
		P_FINISH;
		P_NATIVE_BEGIN;
